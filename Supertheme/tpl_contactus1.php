<?php
/*
	Template Name: Contact us Template 1
*/
	get_header(); 
?>	
	<!-- SLIDER -->				
			...
			<div id="main">
				<div class="wrapper cf">
					...
					<div class="contact-us">
						<div class="left-side-content conatct-form">
							<div class="one-half">
									<?php dynamic_sidebar('sidebar-5');  ?>
							</div>
						</div>
						<div class="right-side-content cf">
						...
						<div class="full-width cf map-contactus">
								<?php     	$gmap_options=unserialize(get_option('Google_map_address')) ; ?>
										<div id="map_canvas" class="map-result conatct-page-map" ><iframe src="https://www.google.com/maps?q=<?php echo $gmap_options['gmap_address']; ?>&output=embed" width="100%" height="295" frameborder="0" style="border:0"></iframe>
							<div class="conatct-page-address-on-map">
